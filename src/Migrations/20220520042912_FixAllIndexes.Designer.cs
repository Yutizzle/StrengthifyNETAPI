...
namespace StrengthifyNETAPI.Migrations
{
    ...
    [Migration("20220520042912_FixAllIndexes")]
    partial class FixAllIndexes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.IncrementFrequency", b =>
                {
                    ...
                    b.HasIndex("IncrementFrequencyId", "Frequency")
                        .IsUnique()
                        .HasDatabaseName("ix_increment_frequencies_increment_frequency_id_frequency");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 5, 20, 4, 29, 11, 930, DateTimeKind.Utc).AddTicks(6857),
                            CreatedById = 1,
                            Frequency = "CYCLE_END",
                            UpdatedAt = new DateTime(2022, 5, 20, 4, 29, 11, 930, DateTimeKind.Utc).AddTicks(6857),
                            UpdatedById = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.Program", b =>
                {
                    ...
                    b.HasIndex("ProgramId", "ProgramName")
                        .IsUnique()
                        .HasDatabaseName("ix_programs_program_id_program_name");
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.ProgramDetail", b =>
                {
                    ...
                    b.HasIndex("ProgramDetailId", "ProgramId", "WorkoutId")
                        .IsUnique()
                        .HasDatabaseName("ix_program_details_program_detail_id_program_id_workout_id");
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.User", b =>
                {
                    ...
                    b.Property<int?>("CurrentProgramCycle")
                        .HasColumnType("integer")
                        .HasColumnName("current_program_cycle");
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.Workout", b =>
                {
                    b.Property<int>("WorkoutId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("WorkoutId")
                        .IsUnique()
                        .HasDatabaseName("ix_workouts_workout_id");
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.WorkoutExercise", b =>
                {
                    ...
                    b.HasIndex("WorkoutExerciseId", "WorkoutId")
                        .IsUnique()
                        .HasDatabaseName("ix_workout_exercises_workout_exercise_id_workout_id");
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.WorkoutExerciseDetail", b =>
                {
                    ...
                    b.HasIndex("WorkoutExerciseDetailId", "WorkoutExerciseId", "Set")
                        .IsUnique()
                        .HasDatabaseName("ix_workout_exercise_details_workout_exercise_detail_id_workout");
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.ProgramDetail", b =>
                {
                    ...
                    b.HasOne("StrengthifyNETAPI.Models.Program", "Program")
                    ...
                    b.HasOne("StrengthifyNETAPI.Models.Workout", "Workout")
                        .WithMany()
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.WorkoutExerciseDetail", b =>
                {
                    ...
                    b.HasOne("StrengthifyNETAPI.Models.IncrementFrequency", "RepsIncrementFrequency")
                        .WithMany()
                        .HasForeignKey("RepsIncrementFrequencyId")
                        .HasConstraintName("fk_workout_exercise_details_increment_frequencies_reps_increme");

                    b.HasOne("StrengthifyNETAPI.Models.IncrementFrequency", "SetDurationIncrementFrequency")
                        .WithMany()
                    ...
                    b.HasOne("StrengthifyNETAPI.Models.IncrementFrequency", "WeightIncrementFrequency")
                        .WithMany()
                        .HasForeignKey("WeightIncrementFrequencyId")
                        .HasConstraintName("fk_workout_exercise_details_increment_frequencies_weight_incre");

                    b.HasOne("StrengthifyNETAPI.Models.WorkoutExercise", "WorkoutExercise")
