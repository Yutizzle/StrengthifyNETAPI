...
namespace StrengthifyNETAPI.Migrations
{
    ...
    [Migration("20220520042312_RemoveWorkoutNameIndex")]
    partial class RemoveWorkoutNameIndex
    {
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.IncrementFrequency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 5, 20, 4, 23, 12, 74, DateTimeKind.Utc).AddTicks(6835),
                            CreatedById = 1,
                            Frequency = "CYCLE_END",
                            UpdatedAt = new DateTime(2022, 5, 20, 4, 23, 12, 74, DateTimeKind.Utc).AddTicks(6835),
                            UpdatedById = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("StrengthifyNETAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2022, 5, 20, 4, 23, 12, 74, DateTimeKind.Utc).AddTicks(6835),
                            UpdatedById = 1,
                            Uuid = new Guid("6d5a8dad-0f3d-4270-80f0-b0c7b7bcd50f")
                        });
                });
